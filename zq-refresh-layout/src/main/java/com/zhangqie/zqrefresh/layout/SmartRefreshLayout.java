package com.zhangqie.zqrefresh.layout;
...
import com.zhangqie.zqrefresh.layout.api.DefaultRefreshFooterCreator;
import com.zhangqie.zqrefresh.layout.api.DefaultRefreshHeaderCreator;
import com.zhangqie.zqrefresh.layout.api.RefreshContent;
import com.zhangqie.zqrefresh.layout.api.RefreshFooter;
import com.zhangqie.zqrefresh.layout.api.RefreshHeader;
import com.zhangqie.zqrefresh.layout.api.RefreshInternal;
import com.zhangqie.zqrefresh.layout.api.RefreshKernel;
import com.zhangqie.zqrefresh.layout.api.RefreshLayout;
import com.zhangqie.zqrefresh.layout.api.ScrollBoundaryDecider;
import com.zhangqie.zqrefresh.layout.constant.DimensionStatus;
import com.zhangqie.zqrefresh.layout.constant.RefreshState;
import com.zhangqie.zqrefresh.layout.constant.SpinnerStyle;
import com.zhangqie.zqrefresh.layout.footer.BallPulseFooter;
import com.zhangqie.zqrefresh.layout.header.BezierRadarHeader;
import com.zhangqie.zqrefresh.layout.impl.RefreshContentWrapper;
import com.zhangqie.zqrefresh.layout.impl.RefreshFooterWrapper;
import com.zhangqie.zqrefresh.layout.impl.RefreshHeaderWrapper;
import com.zhangqie.zqrefresh.layout.listener.OnLoadMoreListener;
import com.zhangqie.zqrefresh.layout.listener.OnMultiPurposeListener;
import com.zhangqie.zqrefresh.layout.listener.OnRefreshListener;
import com.zhangqie.zqrefresh.layout.listener.OnRefreshLoadMoreListener;
import com.zhangqie.zqrefresh.layout.listener.OnStateChangedListener;
import com.zhangqie.zqrefresh.layout.util.DelayedRunnable;
import com.zhangqie.zqrefresh.layout.util.DensityUtil;
import com.zhangqie.zqrefresh.layout.util.ScrollBoundaryUtil;
import com.zhangqie.zqrefresh.layout.util.ViscousFluidInterpolator;
...
import static com.zhangqie.zqrefresh.layout.util.DensityUtil.dp2px;
import static com.zhangqie.zqrefresh.layout.util.SmartUtil.fling;
import static com.zhangqie.zqrefresh.layout.util.SmartUtil.getColor;
import static com.zhangqie.zqrefresh.layout.util.SmartUtil.isScrollableView;
...
//        this.mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.zhangqie.zqrefresh.layout.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link com.zhangqie.zqrefresh.layout.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
